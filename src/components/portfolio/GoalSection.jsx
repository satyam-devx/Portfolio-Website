  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(155,93,229,0.06) 0%, transparent 60%)' }}
      />
      ...
      <div ref={sectionRef} className="section-reveal max-w-4xl mx-auto text-center">
        <div className="flex items-center gap-4 mb-12 justify-center">
          ...
          <span className="font-mono text-xs text-purple-400/60 tracking-widest uppercase">Mission</span>
          <div className="flex-1 h-px bg-white/5 max-w-[100px]" />
        </div>
